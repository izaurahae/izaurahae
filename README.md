![-Izaura Souza-0077B5](https://github.com/user-attachments/assets/7301c62a-3fd0-4d5c-88ef-047324d8d9ed)<p align="center">
  <img src="https://i.pinimg.com/originals/bd/f4/7d/bdf47de4060a0d01a62eb9f110d3e90a.jpg" width="100%" />
</p>
...
![Upload
      ...
      >
        <title id="titleId">Izaura Souza's GitHub Stats, Rank: C</title>
        <desc id="descId">Total Stars Earned: 0, Total Commits in 2025 : 21, Total PRs: 0, Total Issues: 0, Contributed to (last year): 0</desc>
        <style>
          .header {
    ...
    @keyframes rankAnimation {
      ...
      to {
        stroke-dashoffset: 245.4675007770438;
      }
    }
      ...
      <text
        ...
        class="header"
        data-testid="header"
      >Izaura Souza's GitHub Stats</text>
    </g>
      </g>
...
![Uploading -I<svg xmlns="http://www.w3.org/2000/svg" width="124" height="28" role="img" aria-label="IZAURA SOUZA"><title>IZAURA SOUZA</title><g shape-rendering="crispEdges"><rect width="124" height="28" fill="#0077b5"/></g><g fill="#fff" text-anchor="middle" font-family="Verdana,Geneva,DejaVu Sans,sans-serif" text-rendering="geometricPrecision" font-size="100"><text transform="scale(.1)" x="620" y="175" textLength="1000" fill="#fff" font-weight="bold">IZAURA SOUZA</text></g></svg>zaura Souza-0077B5.svg…]()
